    ...
    <>
      ...
      <TextContainer>
        ...
        {(props.sentDate && props.sendMethod && props.sendAddress && (
          <Text>
            We’ve stored it away in a time capsule until {props.sentDate}. When
            the time comes, we’ll send it back to your {props.sendMethod}:{" "}
            {props.sendAddress}.
          </Text>
        )) || (
          <Text>
            We've stored it away and will send it to you when the time comes.
          </Text>
        )}
